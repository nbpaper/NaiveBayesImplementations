...
impl PrequentialSEA {
    pub fn new(clf: NaiveBayes, generator: SeaGenerator, n_wait: usize, max_samples: usize, batch_size:usize) -> PrequentialSEA {
        PrequentialSEA {
            n_wait,
            max_samples,
            generator,
